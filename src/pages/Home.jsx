    ...
    <>
      ...
      <section className="w-full mt-40 mb-20">
        <div className="max-w-7xl mx-auto px-4">
          ...
          >
            <p className="text-lg text-gray-900">Browse</p>
            <h2 id="browser" className="text-5xl font-bold mt-3">What you need in Abia</h2>
          ...
          <div className="flex flex-col lg:flex-row gap-5 mx-auto">
            ...
            <div className="w-full lg:w-1/3">
              <div className="h-full border border-black overflow-hidden flex flex-col group hover:-translate-y-1 hover:shadow-xl transition-all duration-300">
                ...
                <div className="px-5 pt-5 pb-5 flex-grow bg-white">
                  <p className="text-lg font-semibold text-gray-900 mt-5">Health</p>
                  <h3 className="text-2xl font-bold mt-3">Hospitals and clinics</h3>
                  <p className="mt-3 text-xl text-gray-900">Access quality medical care and healthcare services across Abia State. Find hospitals, clinics, and specialists near you.</p>
                  <div className="mt-7 mb-0">
                    <button className="border border-black px-6 py-4 rounded text-lg hover:bg-black hover:text-white transition-colors">View</button>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="w-full py-20 bg-white mt-20">
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <h2 className="text-5xl font-bold mt-3">Latest announcements</h2>
          <p className="text-gray-700 text-lg mt-4">
            Stay informed on government news and important notices
          </p>
          <div className="flex flex-wrap justify-center gap-4 mt-8">
            <button className="border border-black p-5 rounded text-lg font-bold hover:bg-black hover:text-white transition-colors">View all</button>
            <button className="text-lg font-bold p-5">Government</button>
            <button className="text-lg font-bold p-5">Education</button>
            <button className="text-lg font-bold p-5">Health</button>
            <button className="text-lg font-bold p-5">Commerce</button>
          </div>
        </div>
